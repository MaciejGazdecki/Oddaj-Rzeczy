...
function Foundation() {
    ...
    for (let i = 1; i <= data[index].length/perPage; i++) {
        pages.push(<li key={i}
                       onClick={() => setPage(i)}
                       style={page === i ? {border: "1px solid black"} : {border: "none"}}
        >{i}</li>)
    }
                    ...
                    <div className={style.wrapper}>
                        ...
                        <div className={style.buttons}>
                            <div className={style.button}
                                 onClick={() => {setIndex(0);setPage(1)}}
                                 style={index === 0 ? {border: "1px solid black"} : {border: "none"}}>
                                <p>
                                    Fundacjom
                                </p>
                            </div>
                            <div className={style.button}
                                 ...
                                 style={index === 1 ? {border: "1px solid black"} : {border: "none"}}>
                                <p>
                            ...
                            <div className={style.button}
                                 ...
                                 style={index === 2 ? {border: "1px solid black"} : {border: "none"}}>
                                <p>
                                    Lokalnym zbiórkom
                                </p>
                            </div>
